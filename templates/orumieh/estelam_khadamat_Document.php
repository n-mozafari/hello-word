...
<div style = "min-width:100%; width:100%; min-height:500px; direction: rtl; margin:20px auto 20px auto; font-size: 11px;">
    ...
    <div style="clear: both; text-align: right; margin:20px auto 30px auto; font-size:14px; font-weight: bold;">شرکت محترم <?=$receiver['title']?></div>
    <div>
        ...
        <p><span style="font-weight:bold">. موضوع استعلام بها :</span>
            <br>
        ...
        <p>
            ...
            <br>
            مدت اجراي عمليات موضوع استعلام <?=$param['trade']['generalInfo']['data']['tahvilKhadamatModat']?>  خواهد بود .
        </p>
