...
?>
<br/>
<table cellspacing="0" cellpadding="5px" style="font-size: 11px;" dir="rtl">
    <tr>
        <td>
            <table width="100%" cellspacing="0" cellpadding="5px" dir="rtl">
                <tr>
    ...
    <tr>
        <td>
            <table cellpadding="5px" width="100%" style="border:1px solid #000;" dir="rtl">
                <tr>
                        ...
                        <table cellpadding="5px" dir="rtl">
                            ...
                            <tr>
                                <td>
                                    ...
                                    {?>
                                        <table border="1" cellpadding="5px" cellspacing="0" width="100%" dir="rtl">
                                            <tr>
                                            ...
                                            foreach($mainMembers as $member)
                                            {
                                                if($i%4==0)
                                                {
                                                    ...
                                                    <td height="40px"><?=$member['fname'].' '.$member['lname'];?><br><?=$postArr[$member['username']]?>
                                                        ...
                                                        {?>
                                                            <br><?=$db->getImageTag($member['fileEmza'], '', 100, 0, 0, $other);
                                                        }?>
                                                    </td>
                                                    <?
