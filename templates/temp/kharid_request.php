...
<div style = "min-width:100%; width:100%; min-height:500px; direction: rtl; margin:20px auto 20px auto;">
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <td style="border:solid 1px; text-align: center;">تعداد به حروف</td>
    ...
    <div align = "center" style = "min-width:90%; width:90%; margin: auto; ">
        ...
        <table width="100%">
            ...
            <tr><td colspan="3">شماره قراداد و کد حساب تحویل گیرنده</td></tr>
            <tr><td colspan="3">موضوع و محل مصرف</td></tr>
        </table>
    </div>
    <table width="100%">
        <tr>
