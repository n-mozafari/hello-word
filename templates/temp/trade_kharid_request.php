...
<div style = "min-width:100%; width:100%; min-height:500px; direction: rtl; margin:20px auto 20px auto;">
    <div style="margin-top: 50px; width: 100%;">
        ...
        <div style="float: right; margin-top:10px; margin-right:40px; font-size:14px; width:33%; text-align: center;">
            <div><?=$_SESSION['companyTitle']?></div>
            <div><input type="checkbox">ستاد شرکت</div>    
            <div><input type="checkbox">برق ناحیه &nbsp;&nbsp;&nbsp;</div>    
        </div>
    </div>  
        ...
        <table width="100%">
            <tr>
                <td style="border:solid 1px; text-align: center;" width="33%">
                    ...
                    <br>
                    تاریخ درخواست : <?=convertEnNum2FaNum(str_replace('-', '/', $jdf->g2j($param['trade']['kharid_request']['data']['registerDate'])))?>
                </td>
